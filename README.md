...
Este é um site estático multi-página com suporte a modo claro/escuro e troca de idioma (Português/Inglês), construído com HTML, CSS e JavaScript puros.

• Estrutura das páginas

index.html — Página inicial, com apresentação e efeito de digitação (typing effect).
